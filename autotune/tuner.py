...
from openbox.experimental.advanced.safeopt_advisor import SafeOptAdvisor
...
########################### od-bo
    def tune_od(self):
        ...
        task_id = self.task_id
       # print(type(self.env.default_knobs),self.env.default_knobs)
        inikb = Configuration(config_space,self.env.default_knobs)
        #print(inikb)
      #  print(self.env.default_knobs)
        bo = SMBO(self.env.step_openbox_od,
           config_space,
           num_objs=1,
           initial_configurations=[inikb],
           num_constraints=0,
           max_runs=300,
           surrogate_type='gp',
           acq_optimizer_type='local_random',#'random_scipy',#
