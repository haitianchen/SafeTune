...
import argparse
import sys
sys.path.append('/home/ht/knobsTuning/KnobsTuningEA/')
print(sys.path)
from autotune.dbenv import MySQLEnv
from autotune.dbenv_bench import BenchEnv
from autotune.workload import SYSBENCH_WORKLOAD, JOB_WORKLOAD,TPCC_WORKLOAD
...
LOG_PATH="./log"
#LOG_PATH = "/home/ht/knobsTuning/KnobsTuningEA/log"
print(HOST)
